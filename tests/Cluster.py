...
class Cluster(object):
        ...
        for name, keys in producerKeys.items():
            ...
            if name != "eosio":
                ...
                if trans is None or not trans[0]:
                    Utils.Print("ERROR: Failed to transfer funds from lgsio.token to %s." % (name))
                    return None
    ...
    def bootstrap(totalNodes, prodCount, totalProducers, biosHost, biosPort, walletMgr, onlyBios=False):
        ...
        eosioTokenAccount.name="lgsio.token"
        ...
        eosioRamAccount.name="lgsio.ram"
        ...
        eosioRamfeeAccount.name="lgsio.ramfee"
        ...
        eosioStakeAccount.name="lgsio.stake"
