...
// #include <lgsio.token/lgsio.token.wast.hpp>
// #include <lgsio.token/lgsio.token.abi.hpp>

// #include <lgsio.system/lgsio.system.wast.hpp>
// #include <lgsio.system/lgsio.system.abi.hpp>
// =======
...
// <<<<<<< HEAD
//    set_code( N(lgsio.token), lgsio_token_wast );
//    set_abi( N(lgsio.token), lgsio_token_abi );
// =======
...
// >>>>>>> 14a65aca147edf51fd86a958949e237fd430b9ed
   ...
   push_action(N(lgsio.token), N(create), N(lgsio.token), act );

   // issue
   for (account_name a: accs) {
      push_action( N(lgsio.token), N(issue), "lgsio", mutable_variant_object()
                  ("to",      name(a) )
...
//    eosio::chain_apis::read_only::get_table_by_scope_params param{N(lgsio.token), N(accounts), "inita", "", 10};
// =======
...
// >>>>>>> 14a65aca147edf51fd86a958949e237fd430b9ed
   ...
   if (result.rows.size() >= 4) {
      BOOST_REQUIRE_EQUAL(name(N(lgsio.token)), result.rows[0].code);
      BOOST_REQUIRE_EQUAL(name(N(inita)), result.rows[0].scope);
      BOOST_REQUIRE_EQUAL(name(N(accounts)), result.rows[0].table);
// <<<<<<< HEAD
//       BOOST_REQUIRE_EQUAL(name(N(lgsio)), result.rows[0].payer);
...
// >>>>>>> 14a65aca147edf51fd86a958949e237fd430b9ed
   ...
   if (result.rows.size() >= 4) {
      ...
      BOOST_REQUIRE_EQUAL("lgsio", result.rows[0]["payer"].as_string());
      BOOST_REQUIRE_EQUAL("lgsio", result.rows[1]["payer"].as_string());
      BOOST_REQUIRE_EQUAL("lgsio", result.rows[2]["payer"].as_string());
      BOOST_REQUIRE_EQUAL("lgsio", result.rows[3]["payer"].as_string());
   }
   p.show_payer = false;
...
//    set_code( config::system_account_name, lgsio_system_wast );
//    set_abi( config::system_account_name, lgsio_system_abi );
// =======
...
// >>>>>>> 14a65aca147edf51fd86a958949e237fd430b9ed
   ...
   auto bidname = [this]( const account_name& bidder, const account_name& newname, const asset& bid ) {
      return push_action( N(lgsio), N(bidname), bidder, fc::mutable_variant_object()
                          ("bidder",  bidder)
                          ("newname", newname)
                          ("bid", bid)
                          );
